...
class CoursesController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        NotificationCenter.default.addObserver(forName: NSNotification.Name(rawValue: "startLoadingXML"), object: nil, queue: nil) {
            ...
            DispatchQueue.main.async {
                ...
                if let rightBarButtonItem = self.navigationItem.rightBarButtonItem {
                    rightBarButtonItem.customView = activityIndicator
                }
            }
        }
        ...
        NotificationCenter.default.addObserver(forName: NSNotification.Name(rawValue: "ErrorWithXmlLoading"), object: nil, queue: nil) {
            (notification) in
